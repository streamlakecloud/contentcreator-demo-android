...
public class GLRender implements GLSurfaceView.Renderer {
    ...
    public GLRender(Context context, MyGlSurfaceView view) {
        mContext = context;
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        Log.i(TAG, "onSurfaceCreated() mShaderProgram=" + mShaderProgram);
        if (mShaderProgram != 0) {
        ...
        if (mPreviewSize != null) {
            ...
            // mSurfaceTexture.setDefaultBufferSize(2336, 1080);
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        if (mDrawFrameCallback != null) {
            mDrawFrameCallback.onDrawFrame(gl);
        }
    }
    ...
    public void initTexture() {
        ...
        Log.i(TAG, "init texture mTextureId=" + Arrays.toString(mTextureId) + " thread=" + Thread.currentThread());
